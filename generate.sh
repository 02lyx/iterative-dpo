...
my_world_size=2 # how many gpu you use
...
CUDA_VISIBLE_DEVICES=7 python ./generation/gen_hf2.py --model_name_or_path ${infer_model} --dataset_name_or_path ${prompt_dir} --output_dir ${output_dir} --K 16 --temperature 1.0 --local_index 1 --my_world_size ${my_world_size}  &

# CUDA_VISIBLE_DEVICES=6 python ./generation/gen_hf2.py --model_name_or_path ${infer_model} --dataset_name_or_path ${prompt_dir} --output_dir ${output_dir} --K 16 --temperature 1.0 --local_index 0 --my_world_size ${my_world_size}  &
# CUDA_VISIBLE_DEVICES=7 python ./generation/gen_hf2.py --model_name_or_path ${infer_model} --dataset_name_or_path ${prompt_dir} --output_dir ${output_dir} --K 16 --temperature 1.0 --local_index 1 --my_world_size ${my_world_size}  &
# CUDA_VISIBLE_DEVICES=8 python ./generation/gen_hf2.py --model_name_or_path ${infer_model} --dataset_name_or_path ${prompt_dir} --output_dir ${output_dir} --K 16 --temperature 1.0 --local_index 2 --my_world_size ${my_world_size}  &
# CUDA_VISIBLE_DEVICES=9 python ./generation/gen_hf2.py --model_name_or_path ${infer_model} --dataset_name_or_path ${prompt_dir} --output_dir ${output_dir} --K 16 --temperature 1.0 --local_index 3 --my_world_size ${my_world_size}  &
...
# python ./generation/merge_data.py --base_path './data/gen_data' --output_dir './data/gen_data.json' --num_datasets 4